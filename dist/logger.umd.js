...
function data() {
  return {
    logs: [],
    position: this.constructor.POSITION_BOTTOM_LEFT
  }
}

var methods = {
  log: function log (name, value) {
    this.logs.push({ name: name, value: value });
  },
...
function setup(Logger) {
  Logger.POSITION_TOP_LEFT = 'top-left';
  Logger.POSITION_TOP_RIGHT = 'top-right';
  Logger.POSITION_BOTTOM_LEFT = 'bottom-left';
  Logger.POSITION_BOTTOM_RIGHT = 'bottom-right';    
}

function encapsulateStyles(node) {
	setAttribute(node, "svelte-2269781543", "");
}

function add_css() {
	var style = createElement("style");
	style.id = 'svelte-2269781543-style';
	style.textContent = "[svelte-2269781543].container,[svelte-2269781543] .container{position:absolute;opacity:0.9;background-color:#020;color:lime;font-family:monospace;font-size:12px}[svelte-2269781543].top-left,[svelte-2269781543] .top-left{top:0;left:0}[svelte-2269781543].top-right,[svelte-2269781543] .top-right{top:0;right:0}[svelte-2269781543].bottom-left,[svelte-2269781543] .bottom-left{bottom:0;left:0}[svelte-2269781543].bottom-right,[svelte-2269781543] .bottom-right{bottom:0;right:0}";
...
function Logger(options) {
	...
	if (!document.getElementById("svelte-2269781543-style")) { add_css(); }
